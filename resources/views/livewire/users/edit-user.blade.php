        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">{{ __('messages.Edit user') }}</h2>
                        <p class="mt-1 text-sm text-gray-600">{{ __('messages.Edit the user's information.') }}</p>
                    </div>
                ...
                <form wire:submit="update" class="space-y-6">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" wire:model="name" id="name" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="{{ __('messages.Full name') }}">
                            </div>
                        ...
                        <!-- Email -->
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700">{{ __('messages.Email address') }}</label>
                            <div class="mt-1">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="password" wire:model="password" id="password" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="{{ __('messages.Leave blank to keep unchanged.') }}">
                            </div>
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-medium text-gray-700">{{ __('messages.Confirm password') }}</label>
                            <div class="mt-1">
                                <input type="password" wire:model="password_confirmation" id="password_confirmation" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="{{ __('messages.Leave blank to keep unchanged.') }}">
                            </div>
                        </div>
