        ...
        <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-4">
                    <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('messages.Titel') }}</label>
                ...
                <!-- Slug -->
                <div class="col-span-6 sm:col-span-4">
                    <label for="slug" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('messages.Slug') }}</label>
                ...
                <div class="col-span-6">
                    <label for="content" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('messages.Inhoud') }}</label>
