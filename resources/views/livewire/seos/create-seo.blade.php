        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">{{ __('New role') }}</h3>
                ...
                <form wire:submit="save">
                    <div class="px-4 py-5 bg-white dark:bg-gray-800 sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ __('Icon') }}</label>
                                <div class="relative">
                                    <button
                                        type="button"
                                    ...
                                    >
                                        ...
                                        @else
                                            <span class="text-gray-500">{{ __('Select an icon') }}</span>
                                        @endif
