...
return [
    ...
    | la classe validateur. Certaines de ces règles ont plusieurs versions,
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute fourni a été trouvé dans une fuite de données. Veuillez choisir un autre :attribute.',
    ],
    ...
    | des attributs en utilisant la convention "attribut.règle" pour nommer les lignes.
    | Cela permet de spécifier rapidement une ligne de langage personnalisée pour
    ...
    */
    ...
    | des attributs par des termes plus conviviaux comme "Adresse e-mail"
    | au lieu de "email". Cela nous aide à rendre notre message plus expressif.
    |
    */
