...
return [
    ...
    | utilizados por la clase validadora. Algunas de estas reglas tienen varias
    | versiones, como las reglas de tamaño. Siéntase libre de modificar cada uno
    ...
    */
    ...
    | que sea rápido especificar una línea de idioma personalizada para una regla
    | específica de un atributo dado.
    |
    */
    ...
    |---------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se usan para reemplazar el marcador de posición
    | del atributo por algo más amigable para el lector, como "Dirección de correo electrónico"
